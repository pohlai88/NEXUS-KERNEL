      ...
      <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
        ...
        <td className="py-4 px-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-body font-medium text-gray-900">{user.name}</div>
        ...
        <td className="py-4 px-4">
          ...
          <div className="text-caption text-gray-500">{user.currency}</div>
        </td>
        ...
        <td className="py-4 px-4">
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={menuRef}>
              ...
              {showMenu && (
                <div
                  className="absolute right-0 top-full mt-1 bg-white rounded-lg
                ...
                >
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-body hover:bg-gray-50
                               transition-colors"
                  >
                    Edit
                  </button>
          ...
          <td colSpan={6} className="py-4 px-4">
            <div className="ml-14 grid grid-cols-3 gap-6">
              {user.activityDetails.map((detail, idx) => (
                <div key={idx}>
                  <div className="text-caption font-semibold text-gray-700 mb-1">
