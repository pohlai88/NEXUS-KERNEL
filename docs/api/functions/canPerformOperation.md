...
[@aibos/kernel](../README.md) / canPerformOperation

# Function: canPerformOperation()

> **canPerformOperation**(`manifest`, `conceptId`, `operation`, `roleId`): `boolean`

Defined in: [src/manifest.ts:438](https://github.com/pohlai88/NEXUS-KERNEL/blob/536b1ee182a1f0e1cca915c7ff0a36317c6af611/src/manifest.ts#L438)
