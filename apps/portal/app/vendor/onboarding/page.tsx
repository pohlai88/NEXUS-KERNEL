...
export default async function VendorOnboardingPage() {
      ...
      <div className="na-container na-mx-auto na-p-6">
        <div className="na-card na-p-6 na-text-center">
          ...
          <p className="na-body na-mt-2">
            You need vendor access to view onboarding status.
          </p>
          <Link
  ...
  const submittedDocIds = onboarding?.submitted_documents as
    | string[]
    | undefined;
  const submittedDocs = submittedDocIds
    ? await Promise.all(
        submittedDocIds
          .map((docId) => docRepo.getById(docId))
          .filter((p) => p !== null)
      )
    : [];
  ...
  const requiredDocs =
    (onboarding?.required_documents as Array<{
      id: string;
      name: string;
      type: string;
    }>) || [];
  ...
  const checklistItems =
    (onboarding?.checklist_items as Array<{
      id: string;
      name: string;
      completed: boolean;
    }>) || [];
    ...
    <div className="na-container na-mx-auto na-p-6">
      ...
      {!onboarding ? (
        <div className="na-card na-p-6 na-text-center">
          ...
          <p className="na-body na-mt-2">
            Your onboarding process has not been initiated. Please contact your
            procurement team.
          </p>
          <Link
            href="/vendor/dashboard"
        ...
        <>
          ...
          <div className="na-card na-p-6 na-mb-6">
            ...
            <div className="na-mb-6">
              <div className="na-flex na-items-center na-justify-between na-mb-2">
                <span className="na-body na-font-semibold">
                  Current Stage:{" "}
                  {onboarding.stage.replace("_", " ").toUpperCase()}
                </span>
            ...
            <div className="na-grid na-grid-cols-1 md:na-grid-cols-6 na-gap-2 na-mt-6">
              {[
                ...
                const isCompleted =
                  stageProgress[onboarding.stage] > stageProgress[stage];
                return (
                  <div
                    key={stage}
                    className={`na-card na-p-3 na-text-center ${
                      isActive
                        ? "na-bg-primary-subtle"
                        : isCompleted
                        ? "na-bg-ok-subtle"
                        : "na-bg-paper-2"
                    }`}
                  >
                    <div className="na-metadata na-text-xs na-mb-1">
                      {stage.replace("_", " ")}
                    </div>
          ...
          <div className="na-card na-p-6 na-mb-6">
            ...
            {requiredDocs.length === 0 ? (
              ...
              <div className="na-space-y-3">
                {requiredDocs.map((doc) => {
                  const submitted = submittedDocs.find((d) =>
            ...
            {onboarding.stage === "document_collection" &&
              onboarding.status === "in_progress" && (
                <div className="na-mt-6 na-card na-p-4 na-bg-paper-2">
                  ...
                  <p className="na-body na-text-sm na-mb-4">
                    Please contact your procurement team to upload required
                    documents. Document upload functionality will be available
                    soon.
                  </p>
                  <Link
                    href="/vendor/cases"
            ...
            <div className="na-card na-p-6 na-mb-6">
              ...
              <div className="na-space-y-2">
                {checklistItems.map((item) => (
                  <div
                    key={item.id}
                    className="na-card na-p-3 na-flex na-items-center na-gap-3"
                  >
                    <input
                      type="checkbox"
                    ...
                    <span
                      className={
                        item.completed ? "na-body na-line-through" : "na-body"
                      }
                    >
                      {item.name}
                    </span>
