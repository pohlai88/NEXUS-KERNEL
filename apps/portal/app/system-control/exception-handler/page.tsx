...
export default async function ExceptionHandlerPage({
  searchParams,
}: ExceptionHandlerPageProps) {
  ...
  try {
    if (tenantIdsToQuery.length > 0) {
      ...
      const escalationsData = await breakGlassRepo.getBySeniorManager(
        ctx.actor.userId
      );
      escalations = escalationsData.filter(
  ...
  const totalExceptions =
    blockedInvoices.length + blockedCases.length + escalations.length;
        ...
        <div className="na-space-y-6">
                    ...
                    <div className="na-flex na-items-start na-justify-between">
                      <div className="na-flex-1">
                        ...
                        <div className="na-text-sm na-text-muted na-mb-1">
                          Vendor:{" "}
                          {invoice.vmp_vendors?.name ||
                            invoice.vmp_vendors?.legal_name ||
                            "Unknown"}
                        </div>
                        <div className="na-text-sm na-text-muted na-mb-1">
                          Amount: {invoice.currency_code || "USD"}{" "}
                  ...
                  >
                    <div className="na-flex na-items-start na-justify-between">
                      <div className="na-flex-1">
                        ...
                        <div className="na-text-sm na-text-muted na-mb-1">
                          Vendor:{" "}
                          {caseItem.vmp_vendors?.name ||
                            caseItem.vmp_vendors?.legal_name ||
                            "Unknown"}
                        </div>
          ...
          {totalExceptions === 0 && (
            <div className="na-card na-p-12 na-text-center">
              ...
              <p className="na-body na-text-muted">
                The system is running smoothly. All invoices are processing
                normally.
              </p>
            </div>
          )}
