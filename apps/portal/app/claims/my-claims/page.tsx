        ...
        <div className="na-container na-mx-auto na-p-6">
            ...
            <div className="na-card na-p-6 na-mb-6">
                ...
                <form action="/claims/actions" method="post" className="na-space-y-4">
                    ...
                    <div>
                        <label className="na-metadata na-mb-2 na-block">Merchant Name *</label>
                        <input
                            type="text"
                            name="merchant_name"
                    ...
                    {/* Snap & Submit Upload */}
                    <div>
                        <label className="na-metadata na-mb-2 na-block">Receipt * (No Receipt, No Coin)</label>
                        <MobileUpload
                            ...
                            <div key={claim.id} className="na-card na-p-4 na-border">
                                <div className="na-flex na-justify-between na-items-start na-mb-2">
                                    ...
                                    <div className="na-text-right">
                                        <div className="na-data-large">${claim.amount.toFixed(2)}</div>
                                        <span className={`na-status na-status-${claim.status === 'APPROVED' ? 'ok' : claim.status === 'REJECTED' ? 'bad' : 'pending'}`}>
                                            {claim.status}
                                        </span>
                                    </div>
                                </div>
