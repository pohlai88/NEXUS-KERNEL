...
export const AIBOS_DESIGN_SYSTEM: ConceptDefinition = defineConcept({
  ...
  description: 'Single Source of Truth (SSOT) for all UI/UX design tokens, semantic classes, components, and utilities. All styling, theming, and design decisions must derive from this system.',
  version: '1.1.0',
});
